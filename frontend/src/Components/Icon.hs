...
icon IconConfig {..} = elSvg
  "svg"
  (   (\s d x -> mconcat
        [ "viewBox" =: "0 0 36 36"
        , "xmlns" =: "http://www.w3.org/2000/svg"
        , "area-hidden" =: "true"
        , "class" =: ("icon" <> classStr x)
        , "style" =: style s d
        ]
      )
  <$> _iconConfig_status
